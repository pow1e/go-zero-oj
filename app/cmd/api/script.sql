...
INSERT INTO `go-zero-oj`.user (id, identity, name, password, phone, mail, finish_problem_num, submit_num, created_at, updated_at, deleted_at) VALUES (1, 'user_1', '李四', '$2a$10$wh6fiea0hn.ypvYwxcA.mu/EXD2sEsfb4SwVk2EHLdbGTLKgSTymm', '', '', 0, 0, '2023-09-11 16:15:06', '2023-09-11 16:15:06', null);
INSERT INTO `go-zero-oj`.user (id, identity, name, password, phone, mail, finish_problem_num, submit_num, created_at, updated_at, deleted_at) VALUES (2, 'user_2', '王五', '$2a$10$t9w/Tv4u5fbLjTNsUleGZOdXupNrJLEF/S1g0XApyLf9oF0hN4ZES', '', '', 0, 0, '2023-09-13 09:48:43', '2023-09-13 09:48:43', null);
INSERT INTO `go-zero-oj`.user (id, identity, name, password, phone, mail, finish_problem_num, submit_num, created_at, updated_at, deleted_at) VALUES (3, 'user_3', '老刘', '$2a$10$mWELW.eml8M0bq5umwn57OxvX0iTqeszUY1.9JpKeGrcc3V3sV6Ou', '', '', 0, 0, '2023-09-13 09:51:01', '2023-09-13 09:51:01', null);
INSERT INTO `go-zero-oj`.user (id, identity, name, password, phone, mail, finish_problem_num, submit_num, created_at, updated_at, deleted_at) VALUES (4, 'user_4', '张七', '$2a$10$6PW7uEAVIVZIOAKkfcT1UuYoMlIKKA5SQUcMDML6jxmcjKu9R8jw.', '', '', 0, 0, '2023-09-13 09:53:41', '2023-09-13 09:53:41', null);
INSERT INTO `go-zero-oj`.user (id, identity, name, password, phone, mail, finish_problem_num, submit_num, created_at, updated_at, deleted_at) VALUES (5, 'user_5', '老王', '$2a$10$bOm/CQl2i2LsikUlQrZS..3XfA5EFWS1IgS6Oy2.uIIw4QGugcPAi', '', '', 0, 0, '2023-09-13 09:54:35', '2023-09-13 09:54:35', null);
